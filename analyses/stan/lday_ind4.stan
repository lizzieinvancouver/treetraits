...
//	real b_inter_wc1_sp_ind[n_ind]; 
//	real b_inter_wc2_sp_ind[n_ind]; 
//	real b_inter_pc1_sp_ind[n_ind]; 
//	real b_inter_pc2_sp_ind[n_ind]; 
//	real b_inter_sc1_sp_ind[n_ind]; 
//	real b_inter_sc2_sp_ind[n_ind]; 
